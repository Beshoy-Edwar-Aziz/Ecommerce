...
export class AboutComponent {
  users=['omr','ali','lol','call','saul'];
  images=['../assets/images/clock1.jpg','../assets/images/clock2.jpg','../assets/images/rev.jpg','../assets/images/shoes.jpg','../assets/images/re4r.jpg','../assets/images/kiryu.jpg'];
  isSale=true;
  change(){
